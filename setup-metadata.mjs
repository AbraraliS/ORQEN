...
async function applyMetadata() {
  ...
  const arrRelations = [
    {
      ...
      name: "usage",
      col: "organization_id",
      refTable: "organization_usage",
    },
    {
      table: "organizations",
      name: "members",
      col: "organization_id",
      refTable: "organization_members",
    },
  ...
  const workflowOrgIdFilter = {
    workflow: { organization: { members: { user_id: { _eq: "X-Hasura-User-Id" } } } },
  };
  const workflowRunOrgIdFilter = {
    workflow_run: { organization: { members: { user_id: { _eq: "X-Hasura-User-Id" } } } },
  };
